...
const WhatIsAtlas = () => {
  return (
    <section id="philosophy" className="py-32 bg-atlas-dark text-atlas-primary">
      <div className="container-custom">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-16">
            <svg 
              className="w-6 h-6 text-atlas-primary/60" 
              viewBox="0 0 24 24" 
              fill="none" 
              stroke="currentColor" 
              strokeWidth="1.5"
            ...
            <h2 className="text-sm tracking-[0.3em] uppercase font-light text-atlas-primary/80">
              WHAT IS ATLAS
            </h2>
          </div>
          ...
          <div className="space-y-12">
            ...
            <motion.p
              ...
              className="text-lg md:text-xl font-light leading-relaxed text-atlas-primary/90"
            >
