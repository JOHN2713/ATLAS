...
const AreasOfFocus = () => {
  ...
  return (
    <section className="py-24 bg-atlas-primary relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          <div className="w-12 h-px bg-atlas-dark/20" />
        ...
        {/* Grid of services */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16 max-w-6xl">
