...
const Insights = () => {
  ...
  return (
    <section id="insights" className="py-24 bg-atlas-primary relative overflow-hidden">
      {/* Grid pattern background */}
      <div 
        className="absolute inset-0 opacity-[0.03]"
        style={{
          backgroundImage: `
            linear-gradient(to right, #0d1926 1px, transparent 1px),
            linear-gradient(to bottom, #0d1926 1px, transparent 1px)
          `,
      ...
      <div className="container-custom max-w-5xl relative z-10">
            ...
            >
              <div className="flex gap-8">
                ...
                <div className="flex-1">
                  {/* Category and date */}
                  <div className="text-xs tracking-widest text-atlas-dark/50 mb-4">
                  ...
                  {/* Excerpt */}
                  <p className="text-base leading-relaxed text-atlas-dark/60 mb-4">
                    {insight.excerpt}
                  </p>
        ...
        {/* Bottom section - could add "Read all perspectives" button here if needed */}
      </div>
    </section>
  );
};
